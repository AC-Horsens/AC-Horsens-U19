...
def Process_data_spillere(events,df_xg,df_matchstats,groundduels):
    ...
    def fullbacks():
        ...
        df_backs['Passing'] = df_backs[['percent_successfulPassesToFinalThird score','percent_successfulPassesToFinalThird score','percent_successfulPasses score','Possession value added score']].mean(axis=1)
    ...
    def number6():
        ...
        df_sekser['Progressive ball movement'] = df_sekser[['average_shotAssists score','average_progressivePasses score','average_forwardPasses score','average_successfulForwardPasses score','percent_successfulPassesToFinalThird score']].mean(axis=1)
